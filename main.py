...
Add analysis
confirm MSD
orient code on tracks sheet into summary sheet
...
parameters = {'Interval': 15, 'arrest_displacement': 3.0, 'contact_length': None, 'arrested': 0.95, 'moving': 4,
              ...
              'x_for': 'X Coordinate', 'y_for': 'Y Coordinate', 'z_for': 'Z Coordinate', 'parent_id2': 'Parent ID',
              'category_col': 'Category', 'Contact': False, 'Tau_val': 6, 'Infile_cats': 0}
    ...
    def main():
        try:
            ...
            while p_bar_increase < 1:
                ...
                infile_categories = 0
                if parameters['Infile_cats'] != 0:
                    infile_categories = parameters['Infile_cats']
                    print(infile_categories)
