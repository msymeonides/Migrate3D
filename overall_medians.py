...
def overall_medians(cell, df_all_calcs, cols_angles, cols_euclidean):
    ...
    for col_ in cols_angles:
        angle_median = list(df_all_calcs.loc[df_all_calcs['Cell ID'] == cell, col_])
    ...
    for cols_ in cols_euclidean:
        euclidean_median = df_all_calcs.loc[df_all_calcs['Cell ID'] == cell, cols_]
